  ...
  <div class="page page-migration-guide">
    ...
    <el-card shadow="never" class="guide-card">
      ...
      <div class="migration-actions">
        <el-button @click="onStartBackup">{{ t('migration.backupGuide.btnStartBackup') }}</el-button>
...
function onStartBackup() {
  void router.push({ name: 'migration-backup-run' })
}

const backupSteps = computed(() => [
  { title: t('migration.backupGuide.s1Title'), desc: t('migration.backupGuide.s1Desc') },
  { title: t('migration.backupGuide.s2Title'), desc: t('migration.backupGuide.s2Desc') },
  { title: t('migration.backupGuide.s3Title'), desc: t('migration.backupGuide.s3Desc') },
  { title: t('migration.backupGuide.s4Title'), desc: t('migration.backupGuide.s4Desc') },
])
